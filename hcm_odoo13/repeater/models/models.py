...
class Repeater(models.Model):
    ...
    long = fields.Float(string="Longtitude", digits=(16,6))
    ...
    mang2g3g4g = fields.Selection([('2G','2G'),('3G','3G'),('4G','4G'),('2G/3G','2G/3G'),('2G/3G/4G','2G/3G/4G')],string='Mạng')
    ...
    department_id = fields.Many2one('repeater.department', string="Đài")
